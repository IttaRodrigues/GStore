...
{ 
    ...
    [Required(ErrorMessage = "Por favor, infome sua Data de Nascimento")]
    public DateTime? DataNascimento { get; set; } = null;

    [Display(Prompt = "Informe seu Email" )]
    [Required(ErrorMessage = "Por favor, informe seu Email")]
    [EmailAddress(ErrorMessage = "Por favor, informe seu Email Valido!")]
    ...
    [DataType(DataType.Password)]
    [Display(Name = "Confirme Senha de Acesso", Prompt = "Confirme sua Senha de Acesso" )]
